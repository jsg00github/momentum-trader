...
function MarketDashboard({ onTickerClick }) {
    ...
    const { indices, sectors, expert_summary } = marketData;
    ...
    return (
        <div className="space-y-8">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                            <h2 className="text-xl font-bold text-white tracking-tight flex items-center gap-2">
                                <span>🎙️</span> Daily Market Briefing
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                            <div className="bg-slate-900/30 p-3 rounded-lg border border-slate-700/30">
                                <h4 className="text-slate-400 font-bold uppercase text-[10px] mb-2 tracking-wider">The Close</h4>
                            ...
                            <div className="bg-slate-900/30 p-3 rounded-lg border border-slate-700/30">
                                <h4 className="text-slate-400 font-bold uppercase text-[10px] mb-2 tracking-wider">Momentum & Risk</h4>
                            ...
                            <div className="bg-blue-900/10 p-3 rounded-lg border border-blue-500/20">
                                <h4 className="text-blue-400 font-bold uppercase text-[10px] mb-2 tracking-wider">Action Plan</h4>
            ...
            <div>
                <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wide mb-4">Market Health</h3>
            ...
            {/* Section 2: AI Picks */}
            <div>
                <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wide mb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
                        <div className="text-purple-400 font-bold mb-3 flex justify-between">
                            <span>🚀 Aggressive</span>
                            <span className="text-xs opacity-60 font-normal">High Mom + Vol</span>
                        </div>
                        {Aggressive.length === 0 ? <div className="text-slate-600 text-sm italic">No picks found.</div> : Aggressive.map(item => renderAiCard(item, 'Aggressive'))}
                    </div>

                    {/* Moderate */}
                    <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
                        <div className="text-blue-400 font-bold mb-3 flex justify-between">
                            <span>⚖️ Moderate</span>
                            <span className="text-xs opacity-60 font-normal">Steady Trend</span>
                        </div>
                        {Moderate.length === 0 ? <div className="text-slate-600 text-sm italic">No picks found.</div> : Moderate.map(item => renderAiCard(item, 'Moderate'))}
                    </div>

                    {/* Safe */}
                    <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
                        <div className="text-green-400 font-bold mb-3 flex justify-between">
                            <span>🛡️ Safe</span>
                            <span className="text-xs opacity-60 font-normal">Dip / Value</span>
                        </div>
                        {Safe.length === 0 ? <div className="text-slate-600 text-sm italic">No picks found.</div> : Safe.map(item => renderAiCard(item, 'Safe'))}
                    </div>
                </div>
            </div>
